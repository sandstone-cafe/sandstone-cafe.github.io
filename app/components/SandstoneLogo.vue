 ...
 * SandstoneLogo.vue
 * ------------------
 * Animated handwritten SVG logo with pen‑pressure simulation.
 *
 * Props:
 * - className: Tailwind classes for sizing/placement
 * - animate: enables write‑on animation (default true)
 * - compact: hides underline for navbar use (default false)
 *
 * Fully SSR‑safe:
 * - No DOM access
 * - No JS animation triggers
 * - All animation handled by CSS keyframes
 */

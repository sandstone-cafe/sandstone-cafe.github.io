...
// If 'name' is a prop, define it here
...
<template>
  ...
  <div class="wrapper">
    <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" version="1.0" viewBox="0 0 3040 825">
      <path id="s-path" class="sandstone-logo"
      ...
      <path id="andstone-path" class="sandstone-logo"
      ...
      <path id="t-cross-path" class="sandstone-logo" d="m 1390,307 c 0,0 148,-3 374,-5 h 350 c 163,2 8,17 8,17" />

      <path id="underline" class="sandstone-logo"
...
/* ── Static (no animation) ── */
.sandstone-static path {
  stroke-dashoffset: 0 !important;
}
/* ── Animated variant ── */
.sandstone-animate #s-path {
  stroke-dasharray: 5838;
  animation: writeS 3s linear forwards;
}
.sandstone-animate #andstone-path {
  stroke-dasharray: 8577;
  animation: writeAndStone 3s linear forwards;
}
.sandstone-animate #t-cross-path {
  stroke-dasharray: 868;
  animation: writeTCross 3s linear forwards;
}
.sandstone-animate #underline {
  stroke-dasharray: 2212;
  animation: writeUnderline 3s linear forwards;
}
@keyframes writeS {
  0%        { stroke-dashoffset: 5838; }
  40%, 100% { stroke-dashoffset: 0; }
}
@keyframes writeAndStone {
  0%, 20%   { stroke-dashoffset: 8577; }
  90%, 100% { stroke-dashoffset: 0; }
}
@keyframes writeTCross {
  0%, 91%   { stroke-dashoffset: 868; }
  93%, 100% { stroke-dashoffset: 0; }
}
@keyframes writeUnderline {
  0%, 94%   { stroke-dashoffset: 2212; }

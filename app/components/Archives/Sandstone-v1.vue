...
<template>
  <div class="wrapper">
    <!-- 8160 Sandstone -->
    <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" version="1.0" viewBox="0 0 3040 825">
      <path id="s-path" xfill="none" xstroke="#000" xstroke-linecap="round" xstroke-width="38"
      ...
      <path id="andstone-path" xfill="none" xstroke="#000" xstroke-linecap="round" xstroke-width="38"
      ...
      <path id="t-cross-path" xfill="none" xstroke="#000000" xstroke-linecap="round" xstroke-width="30"
        d="m 1390,307 c 0,0 148,-3 374,-5 h 350 c 163,2 8,17 8,17" xstyle="display:inline; border: 1px dotted black; "
        inkscape:label="t-cross-path" />

      <path id="underline" fill="none" xstroke="#fff" xstroke-linecap="round" xstroke-linejoin="round" xstroke-width="6"
        xd="M890 700 c37-160 127-29 163-26"
...
.wrapper #s-path {
  stroke-dasharray: 5838;
  animation-name: writeS;
}

@keyframes writeS {
  0% {
    stroke-dashoffset: 5838;
  }
...
.wrapper #andstone-path {
  stroke-dasharray: 8577;
  animation-name: writeAndStone;
}

@keyframes writeAndStone {

  0%,
  20% {
    stroke-dashoffset: 8577;
  }
...
.wrapper #t-cross-path {
  stroke-dasharray: 868;
  animation-name: writeTCross;
}

@keyframes writeTCross {
...
.wrapper #underline {
  stroke-dasharray: 2212;
  animation-name: writeUnderline;
}

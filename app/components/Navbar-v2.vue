 ...
 * Navbar.vue
 * ----------
 * Nuxt 4.3 + Tailwind 4.1 + lucide-vue-next + SandstoneLogo.
 *
 * Features:
 * - Scroll-aware compact logo transition
 * - Smooth-scroll navigation
 * - Dark mode toggle (Nuxt-safe)
 * - Mobile menu with animated height
 * - Hydration-safe scroll listeners
 */
  ...
  <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16 md:h-20">
        ...
        <!-- Logo wrapper -->
        <a href="#home" @click.prevent="scrollToId('#home')" class="relative flex items-center h-12 overflow-hidden">
          <!-- Text logo -->
          <span
